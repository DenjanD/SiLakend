    ...
    class m_validasi extends CI_Model{
        ...
        public function get_data(){
            ...
            if($this->session->userdata('namalevel') == 'Administrator'){   
                ...
                $this->db->where('status !=',$status4);
                $this->db->where('status !=',$status5);
                $this->db->where('status !=',$status6);
                $this->db->where('status !=',$status7);
        ...
        public function valid_data1($idvalidasi,$statusvalidasi,$statusord,$noaccorder){
            if($this->session->userdata('namalevel') == 'Sub Bagian Umum'){
                ...
                else if($this->session->userdata('namalevel') == 'Administrator'){
                    //Khusus Order Sub Bagian Umum
